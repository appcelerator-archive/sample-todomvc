(function() {
    ...
    typeof exports != "undefined" ? Backbone = exports : Backbone = root.Backbone = {};
        ...
        set: function(key, value, options) {
            ...
            for (attr in attrs) {
                ...
                if (!_.isEqual(prev[attr], val) || _.has(now, attr) != _.has(prev, attr)) {
                    ...
                    options.silent || (this._pending[attr] = !0);
                } else {
    ...
    _.extend(Collection.prototype, Events, {
        ...
        sort: function(options) {
            ...
            this.comparator.length == 1 ? this.models = this.sortBy(boundComparator) : this.models.sort(boundComparator);
        ...
        fetch: function(options) {
            options = options ? _.clone(options) : {};
            options.parse === undefined && (options.parse = !0);
        ...
        _onModelEvent: function(event, model, collection, options) {
            ...
            event == "destroy" && this.remove(model, options);
    ...
    _.extend(History.prototype, Events, {
        ...
        navigate: function(fragment, options) {
            ...
            if (this._hasPushState) {
                frag.indexOf(this.options.root) != 0 && (frag = this.options.root + frag);
                this.fragment = frag;
    ...
    Backbone.sync = function(method, model, options) {
        ...
        if (Backbone.emulateHTTP) if (type === "PUT" || type === "DELETE") {
        ...
        params.type !== "GET" && !Backbone.emulateJSON && (params.processData = !1);
    ...
    var ctor = function() {}, inherits = function(parent, protoProps, staticProps) {
        var child;
        protoProps && protoProps.hasOwnProperty("constructor") ? child = protoProps.constructor : child = function() {
